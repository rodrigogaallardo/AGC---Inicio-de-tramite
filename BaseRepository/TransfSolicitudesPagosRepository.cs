...
{
    public class TransfSolicitudesPagosRepository : BaseRepository<Transf_Solicitudes_Pagos>
    {
        private readonly IUnitOfWork _unitOfWork;

        public TransfSolicitudesPagosRepository(IUnitOfWork unit) : base(unit)
        {
            if (unit == null)
        ...
        public IEnumerable<Transf_Solicitudes_Pagos> GetByFKIdSolicitud(int id_solicitud)
        {
            IEnumerable<Transf_Solicitudes_Pagos> domains = _unitOfWork.Db.Transf_Solicitudes_Pagos.Where(x =>
        ...
        {
            var lstPagos = (from solpag in _unitOfWork.Db.Transf_Solicitudes_Pagos
