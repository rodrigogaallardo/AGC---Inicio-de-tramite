<%@ Page Title="Modificar contraseña" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageProf.aspx.cs" Inherits="ConsejosProfesionales.Account.ManageProf" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="passwordForm">
        ...
        <h2>Cambiar contraseña</h2>
            ...
            <asp:ChangePassword ID="changepwd" runat="server" CancelDestinationPageUrl="~/Profesionales.aspx" ViewStateMode="Disabled" 
                RenderOuterTable="false" MembershipProvider="SqlMembershipProviderProfesionales" SuccessPageUrl="ManageProf?m=ChangePwdSuccess" >
