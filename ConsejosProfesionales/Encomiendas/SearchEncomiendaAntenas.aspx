<%@ page language="C#" autoeventwireup="true" codebehind="SearchEncomiendaAntenas.aspx.cs" masterpagefile="~/Site.Master" inherits="ConsejosProfesionales.Encomiendas.SearchEncomiendaAntenas" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h2 class="text-center" >
                    Encomienda de Antenas - Búsqueda de Trámites
    </h2>
    <hr />
           ...
           <div class="row" style="float:left;width:70%">
            ...
            <div class="row " style="float:left;width:100%;margin-top:30px">
                        ...
                        <div class="form-group">
                            <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="200" AssociatedUpdatePanelID="updBuscar">
                                <ProgressTemplate>
        ...
        <asp:UpdatePanel ID="updgrdBandeja" runat="server">
            <ContentTemplate>
                ...
                <div class="mtop30 row pleft10 pright10">
                    <div class="col-sm-6">
                        <h4>Encomienda de Antenas - Listado de Trámites</h4>
                    ...
                    OnDataBound="grdTramites_DataBound"
                                ItemType="DataTransferObject.EncomiendaAntenasGrillaDTO"
                                DataKeyNames="id_encomienda,id_estado">
                                <HeaderStyle CssClass="grid-header" />
                                <RowStyle CssClass="grid-row" />
                                <AlternatingRowStyle BackColor="#efefef" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Nº Trámite" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkNroEncomienda" runat="server" Text='<%# Item.id_encomienda %>' OnClick="lnkNroEncomienda_Click"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="FechaEncomienda" DataFormatString="{0:g}" HeaderText="Fecha de inicio" ItemStyle-Width="145px" />
                                    <asp:BoundField DataField="descripcion_tipotramite" HeaderText="Tipo de trámite" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="130px" />
                                    <asp:BoundField DataField="nom_estado" HeaderText="Estado" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="130px" />
