<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarEncomiendasAnt.aspx.cs" MasterPageFile="~/Site.Master" Inherits="ConsejosProfesionales.Encomiendas.ActualizarEncomiendasAnt" %>
    ...
    <div style="text-align: center;">
            ...
            <asp:Panel ID="pnlPage" runat="server" CssClass="PageContainer">
                ...
                <asp:Panel ID="pnlContenido" runat="server" CssClass="box-contenido" BackColor="White">
                    ...
                    <asp:Panel ID="pnlInfoPaso" runat="server" Width="100%">
                            ...
                            <asp:Repeater ID="repeater_certificados" runat="server">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkCertificado" runat="server" CommandArgument='<%# Eval("id_certificado") %>' OnCommand="lnkCertificado_Command">
                                        ...
                                        <span class="text">Certificado-<%# Eval("row").ToString() %></span>
                                    </asp:LinkButton>
                            ...
                            <ContentTemplate>
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div style="padding: 10px; max-height: 250px; overflow: auto">
                                        <asp:GridView ID="grdHistorialEstados" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <div style="width: 100%; padding-top: 10px;">
                                            ...
                                            <table border="0" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnCambiarEstado" runat="server" CssClass="btn btn-primary" Text="Actualizar" OnClick="btnCambiarEstado_Click" /></td>
                                                    <td>
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <asp:LinkButton ID="btnNuevaBusqueda" runat="server" Text="Nueva búsqueda" PostBackUrl="~/Encomiendas/SearchEncomiendaAntenas.aspx" CssClass="btn btn-default" />
                                                    </td>
                                                    <td style="padding-left: 20px">
                                                        <asp:HyperLink ID="btnImprimirComprobante" runat="server" Text="Imprimir Certificación" NavigateUrl="~/Reportes/ImprimirComprobanteAnt.aspx" CssClass="btn btn-default" Target="_blank"></asp:HyperLink>
                                                    </td>
