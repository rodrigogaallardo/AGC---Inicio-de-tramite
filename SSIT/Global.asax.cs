...
namespace SSIT
{
    public class Global : HttpApplication
    {
        ...
        public void Application_AuthenticateRequest(object sender, EventArgs e)
        {
            ...
            LogError.Write("Application_AuthenticateRequest - Token: " + Request.Form["Token"]);
            LogError.Write("Application_AuthenticateRequest - AbsoluteURI: " + Request.Url.AbsoluteUri);
            if (Request.Form["token"] != null && !Request.Url.AbsoluteUri.Contains("AuthenticateAGIP"))
            {
                string returnUrl = Request.Url.AbsoluteUri;
                LogError.Write("Application_AuthenticateRequest - Llamo al AuthenticateAGIPProc");
