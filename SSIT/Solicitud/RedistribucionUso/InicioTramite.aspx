<%@ Page Title="Inicio de Redistribución de Uso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioTramite.aspx.cs" Inherits="SSIT.Solicitud.RedistribucionUso.InicioTramite" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--Confirmacion de nueva redistribución de uso--%>
    <div id="frmConfirmarRedistribucionUso" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <table style="border-collapse: separate; border-spacing: 5px">
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                <p class="mleft10">
                                    Vas solicitar el inicio  un tr&aacute;mite de <strong>REDISTRIBUCION DE USO</strong>.A continuaci&oacute;n se te asignar&aacute; un n&uacute;mero de identificador
                ...
                <div class="modal-footer mleft20 mright20">
                    ...
                    <asp:UpdatePanel ID="updConfirmarNuevaRedistribucionUso" runat="server">
                        <ContentTemplate>

                            <div class="form-inline">
                                <div class="form-group">
                                    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="updConfirmarNuevaRedistribucionUso">
                                        <ProgressTemplate>
                                            <img src="<%: ResolveUrl("~/Content/img/app/Loading24x24.gif") %>" />Procesando...
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </div>
                                <div id="pnlBotonesConfirmarNuevaRedistribucionUso" class="form-group">
                                    <asp:LinkButton ID="btnNuevaRedistribucionUso" runat="server" CssClass="btn btn-primary" OnClick="btnNuevaRedistribucionUso_Click"
                                        OnClientClick="ocultarBotonesConfirmarNuevaRedistribucionUso();">
    ...
    <script type="text/javascript">
        ...
        function showfrmConfirmarNuevaRedistribucionUso() {
            $("#frmConfirmarRedistribucionUso").modal("show");
            return false;
        }

        function ocultarBotonesConfirmarNuevaRedistribucionUso() {
            $("#pnlBotonesConfirmarNuevaRedistribucionUso").hide();
            return false;
        }
