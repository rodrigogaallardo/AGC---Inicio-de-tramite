<%@ Page Language="C#" Title="Bandeja De Entrada" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BandejaDeEntrada2.aspx.cs" Inherits="SSIT.BandejaDeEntrada2" %>
    ...
    <div id="page_content" style="display: none">
        ...
        <asp:UpdatePanel ID="updBuscar" runat="server">
            <ContentTemplate>
                ...
                <asp:HiddenField ID="hid_nro_expediente" runat="server" />
                ...
                <asp:Panel ID="pnlBuscar" runat="server" DefaultButton="btnBuscar" CssClass="form-inline" Visible="False">
                    ...
                    <div class="row mleft10 mtop10">
                        <label class="control-label col-sm-2 mtop5 text-right">Nro. Expediente:</label>
                        <asp:TextBox ID="txtExpediente" runat="server" CssClass="form-control" Width="50%"></asp:TextBox>
                    </div>
                    ...
                    <asp:UpdatePanel ID="updTiposDeTramite" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row mleft10 mtop10">
                                ...
                                <asp:DropDownList ID="ddlEstados" runat="server" Width="50%" AutoPostBack="true"></asp:DropDownList>
                            </div>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="grdBandeja"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataTextField="IdTramite" DataNavigateUrlFormatString="{0}" DataNavigateUrlFields="url"
                            ControlStyle-CssClass="btn-link" HeaderText="Solicitud" ItemStyle-Width="70px" ItemStyle-CssClass="text-center" />
                        ...
                        <asp:BoundField DataField="TipoExpedienteDescripcion" HeaderText="Tipo" ItemStyle-CssClass="text-center min-width-100" HeaderStyle-CssClass="text-center" visible="false"/>
                        <asp:BoundField DataField="EstadoDescripcion" HeaderText="Estado" HeaderStyle-CssClass="text-center min-width-150" />
