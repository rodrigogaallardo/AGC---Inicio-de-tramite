<%@ Page Language="C#" Title="Bandeja De Entrada" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BandejaDeEntrada.aspx.cs" Inherits="SSIT.BandejaDeEntrada" %>
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="grdBandeja"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TipoExpedienteDescripcion" HeaderText="Tipo" ItemStyle-CssClass="text-center min-width-100" HeaderStyle-CssClass="text-center" />
