<%@ Page Title="Inicio de Permiso Muúica y/o Canto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioTramiteMC.aspx.cs" Inherits="SSIT.Solicitud.Permisos.InicioTramiteMC" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="pnlBusquedaTramites">
            ...
            <div class="row">
                <div class="mleft10 col-md-8">
                    <h2>
                        <asp:Label ID="lblTitulo" runat="server" Text="Label">Ingreso de datos del tr&aacute;mite</asp:Label></h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    ...
                    <p class="pad10">
                        En este primer paso, deberá indicar la <strong>habilitación / autorización de actividad económica vigente</strong> para la cual solicitará el permiso accesorio actividad música y/o canto ingresando el año y número del expediente correspondiente.
                    </p>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        ...
                                        <label class="mleft5">-</label>
                                        <asp:DropDownList ID="ddlExpediente_Sector" runat="server" Width="100px" CssClass="mleft5 form-control"></asp:DropDownList>
                                        <label class="mleft5">-</label>
                                        <asp:TextBox ID="txtExpediente_Reparticion" runat="server" Text="DGHP" Width="80px" CssClass="mleft5 form-control"></asp:TextBox>

                                        <div id="Req_Expediente" class="field-validation-error" style="display: none;">
                                            Debe ingresar el a&ntilde;o, n&uacute;mero del expediente, sector y repartici&oacute;n. 
                                        </div>
            ...
            <ContentTemplate>
                ...
                <div class="row ptop20">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="200" AssociatedUpdatePanelID="updTramitesEncontrados">
                            <ProgressTemplate>
                                <img src='<%: ResolveUrl("~/Content/img/app/Loading24x24.gif") %>' style="margin-left: 10px" alt="loading" />Procesando...
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                        
                        <asp:LinkButton ID="btnConfirmar" runat="server" CssClass="btn btn-primary btn-lg" OnClick="btnConfirmar_Click" OnClientClick="$(this).hide();">
    ...
    <div id="frmConfirmarNuevoPermiso" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <table style="border-collapse: separate; border-spacing: 5px">
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                <p class="mleft10">
                                    Vas solicitar el inicio  un trámite de <strong>PERMISO ACCESORIO ACTIVIDAD MUSICA Y/O CANTO</strong>.A continuaci&oacute;n se te asignar&aacute; un n&uacute;mero de identificador
                                    de solicitud, con el que vas a poder continuar/consultar - en cualquier momento - a trav&eacute;s de la opci&oacute;n "Mis Solicitudes".
                                </p>
                ...
                <div class="modal-footer mleft20 mright20">
                    ...
                    <asp:UpdatePanel ID="updConfirmarNuevoPermiso" runat="server">
                        <ContentTemplate>

                            <div class="form-inline">
                                <div class="form-group">
                                    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="updConfirmarNuevoPermiso">
                                        <ProgressTemplate>
                                            <img src="<%: ResolveUrl("~/Content/img/app/Loading24x24.gif") %>" />Procesando...
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                                </div>
                                <div id="pnlBotonesConfirmarNuevoPermiso" class="form-group">
                                    <asp:LinkButton ID="btnNuevoPermiso" runat="server" CssClass="btn btn-primary" OnClick="btnNuevoPermiso_Click"
                                        OnClientClick="ocultarBotonesConfirmarNuevoPermiso();">
    ...
    <script type="text/javascript">
        ...
        function showfrmConfirmarNuevoPermiso() {
            $("#frmConfirmarNuevoPermiso").modal({ backdrop: 'static', keyboard: "false" , show: true});
            return false;
        }

        function ocultarBotonesConfirmarNuevoPermiso() {
            $("#pnlBotonesConfirmarNuevoPermiso").hide();
            return false;
        }
        ...
        function validarBuscarExp() {
            ...
            if (
                ...
                ($.trim($("#<%: txtExpediente_Anio.ClientID %>").val()).length == 0 ||
                    ...
                    $.trim($("#<%: txtExpediente_Reparticion.ClientID %>").val()).length == 0 ) ) {
