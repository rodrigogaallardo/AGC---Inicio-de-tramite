<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AvisosTransferencia.ascx.cs" Inherits="SSIT.Solicitud.Transferencia.Controls.AvisosTransferencia" %>
...
<asp:Panel ID="pnlAvisos" runat="server">
    <div id="box_Avisos" class="accordion-group widget-box" style="background-color: #ffffff">
        <div class="accordion-heading">
            <a id="btnUpDownAvisos" data-parent="#collapse-group" href="#collapseAvisos" data-toggle="collapse" onclick="btnUpDownAvisos_click(this)">
