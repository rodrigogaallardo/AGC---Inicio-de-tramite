<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ubicacion.ascx.cs" Inherits="SSIT.Solicitud.Transferencia.Controls.Ubicacion" %>
                    ...
                    <ItemTemplate>
                            ...
                            <div>
                                ...
                                <asp:Panel ID="pnlbtnEliminar" runat="server">
                                    <asp:LinkButton ID="btnEliminar" runat="server"  CssClass="pull-right btn btn-default" title="Quitar Ubicación" OnClick="btnEliminar_Click" CommandArgument='<%# Eval("IdTransferenciaUbicacion") %>'>
                                  <i class="imoon imoon-close" style="color:#377bb5"></i>                                
                                    </asp:LinkButton>
                                </asp:Panel>
                                   <asp:Panel ID="pnlbtnEditar" runat="server">
                                    <asp:LinkButton ID="btnEditar" CssClass="pull-right btn btn-default" runat="server" title="Editar Ubicación" OnClick="btnEditar_Click" CommandArgument='<%# Eval("IdTransferenciaUbicacion") %>'>
                            ...
                            <div>
                                ...
                                <div class="form-horizontal" style="margin-left: 10px; margin-top: -10px">
                                    ...
                                    <ul>
                                        <li><asp:Label ID="zonificacion" runat="server"></asp:Label>
