<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Pagos.ascx.cs" Inherits="SSIT.Solicitud.Transferencia.Controls.Pagos" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlGenerarBoletaUnica" runat="server" Visible="true">
