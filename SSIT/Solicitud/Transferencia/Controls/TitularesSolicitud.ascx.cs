...
{
    public partial class TitularesSolicitud : System.Web.UI.UserControl
    {
        public void CargarDatos(TransferenciasSolicitudesDTO transferencia)
        {
            ...
            foreach (var personaFisica in transferencia.TitularesPersonasSolicitudFisicas)
            {
                titulares.Add(
                    new TitularesDTO()
                    {
            ...
            if (transferencia.TitularesPersonasSolicitudJuridicas != null)
            {
                foreach (var personaJuridica in transferencia.TitularesPersonasSolicitudJuridicas)
                {
                    titulares.Add(
                         new TitularesDTO()
                         {
                             ...
                             Domicilio = personaJuridica.Calle + " " + (personaJuridica.NroPuerta.HasValue ? personaJuridica.NroPuerta.Value.ToString() : "") +
