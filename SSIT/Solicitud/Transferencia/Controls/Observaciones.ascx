<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Observaciones.ascx.cs" Inherits="SSIT.Solicitud.Transferencia.Controls.Observaciones" %>

<%: Scripts.Render("~/bundles/fileupload") %>
<%: Styles.Render("~/bundles/fileuploadCss") %>

<div id="box_historial" class="accordion-group widget-box" style="background-color: #ffffff">
            ...
            <ContentTemplate>
                                                                                    ...
                                                                                    <ContentTemplate>
                                                                                        <asp:Panel ID="pnlFilesObservaciones" runat="server">
                                                                                            <asp:LinkButton ID="btnSeleccionarFilesObservaciones" runat="server" CssClass="btn btn-sm btn-default fileinput-button">
                                                                                                ...
                                                                                                <input id="fileupload_observaciones" type="file" name="files[]" accept=".dwf,application/pdf">
                                                                                            </asp:LinkButton>
                ...
                <asp:GridView ID="gridObservaciones" runat="server" Style="width: 1125px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NombreCompleto" HeaderText="Calificador" HeaderStyle-CssClass="text-center" ItemStyle-CssClass="text-Center" />
                ...
                <div class="text-center">
                    <asp:HyperLink ID="btnSolicitarTurno" NavigateUrl="http://www.buenosaires.gob.ar/agc/habilitacionesobservadas" Text="Solicitar Turno" Width="200PX" runat="server" CssClass=" btn btn-primary" Target="_blank" Visible="false"></asp:HyperLink>
                </div>
                <br />
                <br />
