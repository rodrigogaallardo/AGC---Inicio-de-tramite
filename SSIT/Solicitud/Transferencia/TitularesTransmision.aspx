<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TitularesTransmision.aspx.cs" Inherits="SSIT.Solicitud.Transferencia.TitularesTransmision" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="page_content" style="display: none">
        ...
        <h2>Titulares de la Solicitud</h2>
        <hr />
        ...
        <div class="row">
            ...
            <div class="col-sm-11">
                ...
                <p class="pad10">
                    En este paso deber&aacute; ingresar los datos correspondientes a los Titulares de la transmisión.                    
                </p>
        ...
        <div id="box_titulares_ANT" class="box-panel">
            <div style="margin: 20px; margin-top: -5px">
                <div style="color: #377bb5">
                    <h4><i class="imoon imoon-users" style="margin-right: 10px"></i>Datos de los titulares ANT</h4>
                    <hr />
                </div>
            </div>
                ...
                <ContentTemplate>
                    <div class="row ptop10 pright15">
                        <div class="cols-sm-12 text-right">
                            <asp:LinkButton ID="btnShowAgregarPFANT" runat="server" CssClass="btn btn-default" OnClick="btnShowAgregarPFANT_Click">
                                        <i class="imoon imoon-user" style="color:#377bb5"></i>
                                        <span class="text">Agregar Persona F&iacute;sica</span>
                            </asp:LinkButton>
                            <asp:LinkButton ID="btnShowAgregarPJANT" runat="server" CssClass="btn btn-default" OnClick="btnShowAgregarPJANT_Click">
            ...
            <asp:UpdatePanel ID="updGrillaTitularesANT" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <%--Grilla de Titulares--%>                    
                    <div>
                        <asp:GridView ID="grdTitularesHabANT" runat="server" AutoGenerateColumns="false" DataKeyNames="id_persona"
                            AllowPaging="false" Style="border: none;" GridLines="None" Width="100%" CssClass="table table-bordered mtop5"
                            CellPadding="3"
                            OnRowDataBound ="grdTitularesHabANT_OnRowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ApellidoNomRazon" HeaderText="Apellido y Nombre / Razon Social" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" />
                                ...
                                <asp:TemplateField ItemStyle-Width="30px" HeaderText="Acciones" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="btnEliminarTitularANT" runat="server" data-tipopersona-eliminar='<%# Eval("TipoPersona") %>' data-toggle="tooltip" title="Eliminar"
                                            data-id-persona-eliminar='<%# Eval("id_persona") %>' CssClass="link-local" OnClientClick="return showConfirmarEliminarANT(this);">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pbottom0">
                                ...
                                <div class="form-horizontal pright10">
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" class="control-label col-sm-2">Apellido/s (*):</asp:Label>
                                        <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="Label2" runat="server" class="control-label col-sm-2">Nombre/s (*):</asp:Label>
                                        <div class="col-sm-4">
                                ...
                                <div class="form-horizontal pright10">
                                    <div class="form-group">
                                        <asp:Label ID="Label3" runat="server" class="control-label col-sm-3" Style="margin-left: -90px">Tipo y Nro de doc.(*):</asp:Label>
                                        <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="Label4" runat="server" class="control-label col-sm-2">C.U.I.T. (*):</asp:Label>
                                        <div class="col-sm-3">
                                ...
                                <div class="form-horizontal pright10">
                                    <div class="form-group">
                                        <asp:Label ID="Label5" runat="server" class="control-label col-sm-2">Tipo Ing. Brutos (*):</asp:Label>
                                        <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="Label6" runat="server" class="control-label col-sm-2">Nº Ing. Brutos:</asp:Label>
                                        <div class="col-sm-4">
                                ...
                                <div class="form-horizontal pright10">
                                    <div class="form-group">
                                        <asp:Label ID="Label7" runat="server" class="control-label col-sm-2">Calle (*):</asp:Label>
                                        <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="Label8" runat="server" class="control-label col-sm-2">Nro de Puerta (*):</asp:Label>
                                        <div class="col-sm-4">
                                            <div class="form-inline">
                                ...
                                <div class="form-horizontal pright10">
                                    <div class="form-group">
                                        <asp:Label ID="Label9" runat="server" class="control-label col-sm-2">Provincia (*):</asp:Label>
                                        <div class="col-sm-4">
                                        ...
                                        <asp:Label ID="Label10" runat="server" class="control-label col-sm-2">Localidad (*):</asp:Label>
                                        <div class="col-sm-4">
                                ...
                                <asp:UpdatePanel ID="updBotonesAgregarPF" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <asp:Label ID="Label12" runat="server" class="mbottom0 pull-left">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer mtop10 mleft20 mright20">
                    <asp:UpdatePanel ID="updBotonesAgregarPJ" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="Panel3" runat="server" DefaultButton="btnAceptarTitPJ">
                                <div class="form-inline">
                                    ...
                                    <asp:Label ID="Label11" runat="server" class="mbottom0 mtop5 pull-left">
                                                Los campos marcados con "(*)" son obligatorios.
                                    </asp:Label>
    ...
    <div id="frmAgregarTitularesSH" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:Panel ID="Panel4" runat="server" DefaultButton="btnAceptarTitSH">
                ...
                <div class="modal-footer mleft20 mright20">
                    ...
                    <asp:UpdatePanel ID="updBotonesIngresarTitularesSH" runat="server">
                        <ContentTemplate>
                            <asp:Panel ID="Panel5" runat="server" DefaultButton="btnAceptarTitSH">
                                <div class="form-inline">
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function showConfirmarEliminarANT(obj) {

            var tipopersona_eliminar = $(obj).attr("data-tipopersona-eliminar");
            var id_persona_eliminar = $(obj).attr("data-id-persona-eliminar");

            $("#<%: hid_tipopersonaANT_eliminar.ClientID %>").val(tipopersona_eliminar);
            $("#<%: hid_id_personaANT_eliminar.ClientID %>").val(id_persona_eliminar);
