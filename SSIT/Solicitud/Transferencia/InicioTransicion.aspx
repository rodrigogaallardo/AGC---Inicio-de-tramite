<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioTransicion.aspx.cs" Inherits="SSIT.Solicitud.Transferencia.InicioTransicion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    ...
                    <p class="pad10">
                        ...
                        que posea la habilitaci&oacute;n vigente que usted desea transferir.<strong> Para acotar la búsqueda se recomienda utilizar el Número de Expediente.</strong>
                    </p>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 form-inline">
                                        ...
                                        <label class="mleft5">-</label>
                                        <asp:DropDownList ID="ddlExpediente_Sector" runat="server" Width="100px" CssClass="form-control">
                                            <asp:ListItem>MGYEA</asp:ListItem>
                                            <asp:ListItem>GCABA</asp:ListItem>
                                        </asp:DropDownList>
    ...
    <div id="pnlResultadoBusqueda" style="display: none">
        <asp:UpdatePanel ID="updTramitesEncontrados" runat="server">
            <ContentTemplate>
                ...
                <br />
                <div id="box_transmision" class="box-panel">

                    <div style="margin: 20px; margin-top: -5px">
                        <div style="color: #377bb5">
                            <h4><i class="imoon imoon-edit" style="margin-right: 10px"></i>Tipos de Transmisión</h4>
                            <hr />
                        </div>
                    </div>
                    <div class="form-horizontal pright10">
                        <div class="form-group">
                            <asp:Label runat="server" class="control-label col-sm-3" Style="margin-left: -90px">Tipo de Transmisión(*):</asp:Label>
                            <div class="col-sm-4">
                                <div class="form-inline">
                                    <asp:DropDownList ID="ddlTipoTransmision" runat="server" Width="300px" CssClass="form-control">
                                    </asp:DropDownList>
                                </div>
                                <div id="Req_TipoTransmision" class="field-validation-error" style="display: none;">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer mleft20 mright20">
                    ...
                    <asp:UpdatePanel ID="updConfirmarNuevaTransmision" runat="server">
                        <ContentTemplate>

                            <div class="form-inline">
                                <div class="form-group">
                                    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="updConfirmarNuevaTransmision">
                                        <ProgressTemplate>
    ...
    <script type="text/javascript">
        ...
        function showfrmConfirmarNuevaTransmision() {
            $("#frmConfirmarNuevaTransmision").modal("show");
            return false;
        }

        function ocultarBotonesConfirmarNuevaTransmision() {
            $("#pnlBotonesConfirmarNuevaTransmision").hide();
            return false;
        }
