<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CargaPlancheta.aspx.cs" Inherits="SSIT.Solicitud.Transferencia.CargaPlancheta" %>
                        ...
                        <ContentTemplate>
                            ...
                            <div style="padding: 0px 10px 10px 10px; width: auto">
                                ...
                                <asp:GridView ID="gridAgregados_db" runat="server" AutoGenerateColumns="false"
                                    ...
                                    ItemType="DataTransferObject.TransferenciasDocumentosAdjuntosDTO"
