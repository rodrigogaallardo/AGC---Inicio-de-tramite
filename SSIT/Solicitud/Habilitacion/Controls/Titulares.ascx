<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Titulares.ascx.cs" Inherits="SSIT.Controls.Titulares" %>
        ...
        <div>
            <asp:GridView ID="grdTitularesHab" runat="server" AutoGenerateColumns="false" DataKeyNames="id_persona"
                ...
                <Columns>
                    ...
                    <%--<asp:BoundField DataField="ApellidoNomRazon" HeaderText="Apellido y Nombre / Razon Social" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />--%>
       ...
       <div id="panelGrillaH">
        ...
        <%--Grilla de Firmantes--%>
            ...
            <asp:GridView ID="grdTitularesTra" runat="server" AutoGenerateColumns="false" DataKeyNames="id_firmante"
                ...
                <AlternatingRowStyle BackColor="#efefef" />
                <Columns>
                  <%--  <asp:BoundField DataField="Titular" HeaderText="Firmante de..." ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" />--%>
