<%@ Page Title="Inicio de Ampliación" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioTramite.aspx.cs" Inherits="SSIT.Solicitud.Ampliacion.InicioTramite" %>
                    ...
                    <table style="border-collapse: separate; border-spacing: 5px">
                        <tr>
                            ...
                            <td style="vertical-align: middle">
                                <p class="mleft10">
                            Vas solicitar el inicio  un trámite de <strong>AMPLIACION DE RUBRO Y/O SUPERFICIE</strong>.A continuaci&oacute;n se te asignar&aacute; un n&uacute;mero de identificador
