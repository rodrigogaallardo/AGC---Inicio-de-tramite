<%@ Page Title=" Ubicación" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ubicacion.aspx.cs" Inherits="SSIT.Solicitud.Consulta_Padron.Ubicacion" %>
<%@ Register Src="~/Solicitud/Habilitacion/Controls/ZonaPlaneamiento.ascx" TagPrefix="uc" TagName="ZonaPlaneamiento" %>
<%@ Register Src="~/Solicitud/Consulta_Padron/Controls/Ubicacion.ascx" TagPrefix="uc1" TagName="Ubicacion" %>
<%@ Register Src="~/Solicitud/Consulta_Padron/Controls/BuscarUbicacion.ascx" TagPrefix="uc1" TagName="BuscarUbicacion" %>
                                ...
                                <div class="row pleft20 mtop10">
                                    ...
                                    <div class="form-group col-md-8">
                                            ...
                                            <asp:GridView 
                                                ...
                                                CellPadding="3" 
                                                ShowHeader="false"        
                                                DataKeyNames="IdConsultaPadronTipoSector"                                         
