<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNuevaPuerta.ascx.cs" Inherits="SSIT.Solicitud.Consulta_Padron.Controls.ucNuevaPuerta" %>
   
<asp:UpdatePanel ID="updSolicitarNuevaPuerta" runat="server">
    <ContentTemplate>


        <asp:GridView ID="gridubicacion" runat="server" AutoGenerateColumns="false" DataKeyNames="IdUbicacion" ItemType="DataTransferObject.UbicacionesDTO"
                            ...
                            <tr>
                                <td style="width: 305px">
                                    ...
                                    <div style="margin-top: 10px; min-height: 250px; min-width: 300px">
                                        ...
                                        <img id="imgFotoParcela_NP" class="img-polaroid" src="<%# GetUrlFoto(300, 250, Item.Seccion, Item.Manzana, Item.Parcela) %>" onload="fotoCargada_NP('imgCargando_NP',this);" onerror="noExisteFotoParcela_NP(this);" style="display: none; border: solid 2px #939393; border-radius:12px; margin:auto " />
                                    </div>
                                </td>
                                        ...
                                        <div style="overflow: auto; max-height: 300px">
                                            ...
                                            <asp:UpdatePanel ID="updPuertas" runat="server" >
                                                <ContentTemplate>
                                                    ...
                                                    <asp:DataList ID="lstPuertas" runat="server" ItemType="DataTransferObject.UbicacionesPuertasDTO"
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <div class="form-inline">
                                                                ...
                                                                <asp:Label ID="lblNroPuerta" runat="server" Text="<%# Item.NroPuertaUbic %>" CssClass="mleft5"></asp:Label>
                                                            </div>
