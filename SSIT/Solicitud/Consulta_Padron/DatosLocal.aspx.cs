...
namespace SSIT.Solicitud.Consulta_Padron
{
    public partial class DatosLocal : BasePage
    {
        ...
        {
            //if (!string.IsNullOrEmpty(Page.RouteData.Values["id_encomienda"].ToString()))
            //{
        ...
        private void CargarDatos(int IdSolicitud)
        {
            ...
            ConsultaPadronDatosLocalBL blEncDl = new ConsultaPadronDatosLocalBL();
            ...
            ConsultaPadronDatosLocalDTO enDl = blEncDl.GetByFKIdConsultaPadron(IdSolicitud).FirstOrDefault();
        ...
        private void CargarMapas(int idsol)
        {
            ...
            var lstUbicaciones = blEncUbi.GetByFKIdConsultaPadron(IdSolicitud);
        ...
        protected void btnContinuar_Click(object sender, EventArgs e)
        {
            ...
            var enDl = blEncDl.GetByFKIdConsultaPadron(IdSolicitud).FirstOrDefault();
            bool alta = false;
            if (enDl == null)
            {
                alta = true;
                enDl = new ConsultaPadronDatosLocalDTO();
                enDl.IdConsultaPadron = IdSolicitud;
