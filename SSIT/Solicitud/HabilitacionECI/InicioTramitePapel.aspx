<%@ Page Title="Inicio de Ampliación" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioTramitePapel.aspx.cs" Inherits="SSIT.Solicitud.HabilitacionECI.InicioTramitePapel" %>
        ...
        <div id="pnlBusquedaTramites">
            ...
            <div class="row">
                ...
                <div class="col-sm-11">
                    ...
                    <p class="pad10">
                        En este primer paso, deber&aacute; ingresar el nro y a&ntilde;o del expediente, que posea la habilitaci&oacute;n vigente que usted desea ampliar.
                    </p>
