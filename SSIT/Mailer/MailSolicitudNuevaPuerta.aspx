<%@ Page Title="" Language="C#" MasterPageFile="~/Mailer/Mail.Master" AutoEventWireup="true" CodeBehind="MailSolicitudNuevaPuerta.aspx.cs" Inherits="SSIT.Mailer.MailSolicitudNuevaPuerta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <asp:FormView ID="FormView1" runat="server" ItemType="StaticClass.MailSolicitudNuevaPuerta" SelectMethod="GetData">
        <ItemTemplate>
            ...
            <div style="margin-left: 20px; margin-top:-20px">
                ...
                <div>
                    <label>Nombre de la calle:</label><label><strong style="padding-left: 5px; color:green"><%# Item.Calle %></label></strong> 
                </div>
                <div>
                    <label>N&uacute;mero de puerta:</label><label><strong style="padding-left: 5px; color:green"><%# Item.NroPuerta %></label></strong> 
                </div>
