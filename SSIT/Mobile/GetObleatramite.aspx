<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetObleatramite.aspx.cs" Inherits="SSIT.Mobile.GetObleatramite" %>
        ...
        <div style="padding-left: 10px; border-top: solid 1px gray;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <b>
                            <asp:Label ID="lblTipoTramite" runat="server"></asp:Label></b>
                    </td>
                </tr>
                <tr>
                    <td>Nro. Solicitud:</td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <b>
                            <asp:Label ID="lblNroCAA" runat="server"></asp:Label></b>
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <div>
                ...
                <asp:Panel ID="pnlSuperficieTramiteAnterior" runat="server" Visible="false">
                    <label>Superficie habilitada seg&uacute;n expediente
                        <asp:Label ID="lblNroExpedienteAnteriorSuperficie" runat="server"></asp:Label>:</label>
            ...
            <asp:Panel ID="pnlRubrosTramiteAnterior" runat="server" Visible="false">
                ...
                <div>
                    <label>Rubros Habilitados según Expediente
                        <asp:Label ID="lblNroExpedienteAnteriorRubros" runat="server"></asp:Label>:</label>
                </div>
            ...
            <br />
            <asp:GridView ID="grdDepositos" runat="server" AutoGenerateColumns="false"
                AllowPaging="false" Style="padding-right: 20px" Visible=" false">
                <Columns>
                    <asp:BoundField DataField="Codigo" HeaderText="Código" ItemStyle-CssClass="celda_center" HeaderStyle-CssClass="celda_center" />
            ...
            <div>
                ...
                <br />
                <asp:Label ID="lblLeyendaProductosInflamables" runat="server" Font-Bold="true"></asp:Label>
            </div>

            <div id="pnlInformacionAdicional" runat="server" style="display: none">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:BulletedList ID="blInfoAdicional" runat="server"></asp:BulletedList>
                        </td>
                    </tr>
                </table>
            </div>
