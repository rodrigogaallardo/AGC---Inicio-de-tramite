...
namespace SSIT.Account
{
    public class AuthenticateAGIPProc
    {
        ...
        public bool ReadData()
        {
            ...
            LogError.Write("returnUrl:" + returnUrl);
            try
            {
                ...
                LogError.Write("token:" + token);
                LogError.Write("keyPrivadaGuardada:" + keyPrivadaGuardada);
                if (!string.IsNullOrWhiteSpace(token) )
                {
                    ...
                    LogError.Write("Header:" + Header);
                    LogError.Write("payloadRecibido:" + payloadRecibido);
                    LogError.Write("keyPublicaRecibida:" + keyPublicaRecibida);
                    LogError.Write("PayloadJsonString:" + PayloadJsonString);
                    ...
                    LogError.Write("TokenValido:" + tokenValido);
