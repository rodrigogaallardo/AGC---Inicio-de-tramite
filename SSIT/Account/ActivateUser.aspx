<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActivateUser.aspx.cs" Inherits="SSIT.Account.ActivateUser" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlActivacionOk" runat="server">
        ...
        <p>
            ...
            <asp:HyperLink ID="lnkIniciarSesion" runat="server" NavigateUrl="~/">Iniciar Sesi&oacute;n</asp:HyperLink>.
        </p>
    </asp:Panel>
