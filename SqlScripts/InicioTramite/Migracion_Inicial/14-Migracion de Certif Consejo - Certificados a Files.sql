...
SELECT @id_tipdocsis =  id_tipdocsis FROM TiposDeDocumentosSistema WHERE cod_tipodocsis = 'CERTIF_CONSEJO_HABILITACION'
SET @cantReg = 0
...
FROM
	Certificados
WHERE
	 TipoTramite = 8		-- Certificación de Consejos
ORDER BY 
	NroTramite
...
BEGIN
	...
	SET @FileName = 'Certificacion-Consejo-' + CAST(@id_file as nvarchar) + '.' + @formato_archivo
	...
	BEGIN
		...
		EXEC @id_docadjunto_sol = Id_Nuevo 'Encomienda_DocumentosAdjuntos'
