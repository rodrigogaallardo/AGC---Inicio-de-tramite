<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActivateUser.aspx.cs" Inherits="AnexoProfesionales.Account.ActivateUser" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlActivacionOk" runat="server">
        ...
        <p>
            ...
            <asp:HyperLink ID="lnkIniciarSesion" runat="server" NavigateUrl="~/Account/Default">Iniciar Sesi&oacute;n</asp:HyperLink>.
        </p>
    </asp:Panel>
