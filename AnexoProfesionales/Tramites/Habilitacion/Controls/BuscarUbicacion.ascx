<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BuscarUbicacion.ascx.cs" Inherits="AnexoProfesionales.Tramites.Habilitacion.Controls.BuscarUbicacion" %>
<%@ Register Src="~/Tramites/Habilitacion/Controls/ucNuevaPuerta.ascx" TagPrefix="uc1" TagName="ucNuevaPuerta" %>
...
<div id="pnlBuscarUbicacion" style="width: 100%;">
                    ...
                    <div id="tabs-1" class="tab-pane box-panel-tab">
                        ...
                        <asp:Panel ID="pnlDomicilio" runat="server" DefaultButton="btnBuscar2" ValidateRequestMode="Enabled">
                            ...
                            <asp:RequiredFieldValidator ID="ReqCalle" runat="server" ErrorMessage="Debe seleccionar una de las calles de la lista desplegable."
                                ...
                                CssClass="alert-small alert-danger" Style="margin-left: 66px"></asp:RequiredFieldValidator>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Debe ingresar el número de puerta"
                                Display="Dynamic" ControlToValidate="txtNroPuerta" ValidationGroup="Buscar2" CssClass="alert-small alert-danger" Style="margin-left: 66px">
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Debe ingresar el número de partida"
                                            ...
                                            CssClass="alert-small alert-danger mleft5"></asp:RequiredFieldValidator>
                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="El número de partida debe ser mayor a 0 (cero)."
                                            Display="Dynamic" ControlToValidate="txtNroPartida" ValidationGroup="Buscar1"
                                            CssClass="alert-small alert-danger mleft5" MinimumValue="1" MaximumValue="99999999"></asp:RangeValidator>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-inline">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Debe ingresar el número de Sección"
                                        Display="Dynamic" ControlToValidate="txtSeccion" ValidationGroup="Buscar3" CssClass="alert-small alert-danger" Style="margin-left: 15px"></asp:RequiredFieldValidator>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Debe ingresar la Manzana."
                                        Display="Dynamic" ControlToValidate="txtManzana" ValidationGroup="Buscar3" CssClass="alert-small alert-danger" Style="margin-left: 20px"></asp:RequiredFieldValidator>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Debe ingresar la Parcela."
                                        Display="Dynamic" ControlToValidate="txtParcela" ValidationGroup="Buscar3" CssClass="alert-small alert-danger" Style="margin-left: 55px"></asp:RequiredFieldValidator>
                        ...
                        <div class="box-panel">
                            <div class="col-sm-12">
                                ...
                                <div class="mtop15 text-justify" id="divAtencion" runat="server">
                                    <b>ATENCIÓN:</b>&nbsp;La puerta ingresada para su consulta no existe catrastalmente
                            Por favor, seleccione una puerta de la parcela que corresponde,
                            en las opciones que se encuentran dentro de los resultados de busqueda.
                                </div>
                                    ...
                                    <asp:TemplateField HeaderText="Ubicación" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            <div style="margin-top: 50px">
                                                <asp:Label ID="Label6" runat="server" CssClass="mtop40" Text='<%# Item.direccion %>' />

                                                <asp:Label ID="Label10" runat="server" CssClass="mtop40" Text='<%# Item.Numero %>' />
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                                    ...
                                                    <td style="width: auto; padding-left: 10px; vertical-align: text-top">
                                                        ...
                                                        <asp:Panel ID="pnlPuertas" runat="server">
                                                            <div style="overflow: auto; max-height: 800px">
                                                                <div class="box-panel" style="margin-left: 5px; width: 700px;">
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <div class="form-inline">
                                                                                        <div class="control-group">
                                                                                            ...
                                                                                            <asp:TextBox ID="txtNroPuerta" Enabled="false" runat="server" Text='<%# Eval("NroPuertaUbic") %>' Width="65px" CssClass="form-control grid-txtNroPuerta"></asp:TextBox>
                                                                ...
                                                                <asp:Panel ID="pnlDeptoLocal" runat="server" Visible="true" CssClass="box-panel pbottom10" Style="margin-left: 5px; width: 700px;">
                                                                    ...
                                                                    <div class=" form-horizontal form-group">
                                                                        <asp:Label ID="Label7" class="control-label col-sm-2" runat="server"><b>Otros:</b></asp:Label>
                                                                        <div class="col-sm-4">
                                                                    ...
                                                                    <div class="form-horizontal form-group">
                                                                        ...
                                                                        <asp:Label ID="Label8" runat="server" CssClass="control-label col-sm-2"><b>Local:</b></asp:Label>
                                                                        <div class="col-sm-4">
                                                                            <asp:TextBox ID="txtLocal" runat="server" MaxLength="30" Width="200px" CssClass="form-control"></asp:TextBox>
                                                                    ...
                                                                    <div class="form-horizontal form-group">
                                                                        ...
                                                                        <asp:Label ID="Label9" runat="server" CssClass="control-label col-sm-2"><b>Torre:</b></asp:Label>
                                                                        <div class="col-sm-2">
                                                                            <asp:TextBox ID="txtTorre" runat="server" MaxLength="2" Width="80px" CssClass="form-control"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function init_Js_updPnlResultadoBuscar() {
            ...
            $("#<%: txtManzana.ClientID %>").on("keyup", function () {
                hideAPH();
            });

            $("#<%: txtParcela.ClientID %>").on("keyup", function () {
                hideAPH();
            });

            $("#<%: txtNroPartida.ClientID %>").on("keyup", function () {
                hideAPH();
            });

            $("#<%: ddlTipoDeUbicacion.ClientID %> option:selected").on("change", function () {
                hideAPH();
            });
            $("#ddlTipoDeUbicacion").change(function () {
                hideAPH();
            });
