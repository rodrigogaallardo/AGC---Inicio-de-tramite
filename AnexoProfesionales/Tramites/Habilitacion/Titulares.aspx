<%@ Page Title="Encomienda - Titulares" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Titulares.aspx.cs" Inherits="AnexoProfesionales.Titulares" %>

<%@ Register Src="~/Tramites/Habilitacion/Controls/Titulares.ascx" TagPrefix="uc1" TagName="Titulares" %>
        ...
        <div class="row">
            ...
            <div class="col-sm-11">
                ...
                <ul style="line-height: 20px">
                    <li><b>Titulares:</b>
                        <div>
                            Son las personas Físicas o Jurídicas a nombres de quien/es saldrá la Habilitación.
                        </div>
                        <br />
                    </li>
...
<%--                                        <asp:TemplateField ItemStyle-Width="30px">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblgrdTitName" runat="server" Width="100%" style="text-align:center;word-wrap: normal; word-break: break-all;" Text='<%# Eval("ApellidoNomRazon") %>' ></asp:Label>
                                        ...
                                        <asp:BoundField DataField="Domicilio" HeaderText="Domicilio Legal" HeaderStyle-HorizontalAlign="Left" />
                        ...
                        <div class="modal-body pbottom0">
                           <asp:HiddenField ID="hid_id_titular_pf" runat="server" />                           
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_ApellidoPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display:none; ">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_NombresPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_TipoNroDocPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_CuitPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el CUIT.
                                        </div>
                                        <div id="ValFormato_CuitPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            formato inv&aacute;lido. Ej: 20012345673
                                        </div>
                                        <div id="ValDV_CuitPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            El CUIT ingresado es inv&aacute;lido.
                                        </div>
                                        <div id="ValDNI_CuitPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_TipoIngresosBrutosPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_IngresosBrutosPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Nro de Ing. Brutos.
                                        </div>
                                        <div id="ValFormato_IngresosBrutosPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_CallePF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_NroPuertaPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-inline">
                                  <asp:label ID="lblTorrePF" runat="server" class="col-sm-4 control-label mleft10">Torre:</asp:label>
                                  <asp:TextBox ID="txtTorrePF" runat="server" MaxLength="3" Width="50px" CssClass="form-control"></asp:TextBox>
                                  ...
                                  <asp:label ID="lblPisoPF" runat="server" class="pleft5 pright5">Piso:</asp:label>
                                    ...
                                    <div class="col-sm-5">
                                      <asp:label ID="lblCPPF" runat="server" class="control-label col-sm-5 mleft5">C&oacute;digo Postal (*):</asp:label>
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_ProvinciaPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_LocalidadPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    <asp:label runat="server" class="control-label col-sm-2">SMS:</asp:label>
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtSmsPF" runat="server" Width="160px" MaxLength="10" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_EmailPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el E-mail.
                                        </div>
                                        <div id="ValFormato_EmailPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="row pright10" >
                                ...
                                <asp:Panel ID="pnlMismoTitular" runat="server" Style="padding: 10px;">
                                   ...
                                   <asp:label ID="Label2" runat="server" class="mbottom0 mtop5 pull-right" >
                                                ...
                                                <div class="form-horizontal pright10 ptop15">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div id="Req_ApellidoFirPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                                                Debe ingresar el/los Apellido/s.
                                                            </div>
                                                        </div>
                                                        <asp:label runat="server" class="control-label col-sm-2">Nombre/s (*):</asp:label>
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div id="Req_NombresFirPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                                                Debe ingresar el/los Nombres/s.
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div id="Req_TipoNroDocFirPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                                                Debe ingresar el Tipo y Nro. de doc.
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-inline">
                                                                ...
                                                                <div id="Req_TipoCaracterLegalFirPF" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                ...
                <div class="modal-body pbottom0">
                    <asp:UpdatePanel ID="updAgregarPersonaJuridica" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:UpdatePanel ID="upd_ddlTipoSociedadPJ" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlTipoSociedadPJ" CssClass="form-control" runat="server" Width="300px"
                                                    OnSelectedIndexChanged="ddlTipoSociedadPJ_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                        <div id="Req_TipoSociedadPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Tipo de Sociedad
                                        </div>
                                    </div>
                                    <div class="col-sm-6 pleft30">
                            ...
                            <div id="rowRazonSocial" class="form-horizontal pright10" style="margin-top:-70px;">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:UpdatePanel ID="upd_txtRazonSocialPJ" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtRazonSocialPJ" runat="server" MaxLength="200" Width="300px"  CssClass="form-control"></asp:TextBox>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>

                                        <div id="Req_RazonSocialPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <asp:label runat="server" class="control-label col-sm-4">C.U.I.T.(*):</asp:label>
                                                                  
                                        <asp:TextBox ID="txtCuitPJ" runat="server" MaxLength="11" Width="140px" CssClass="form-control" Style="display:inline"></asp:TextBox>
                                         <asp:label runat="server" class="col-sm-13">Debe ingresar los 11 dígitos sin guiones</asp:label>   
                                        <div id="Req_CuitPJ" class="alert alert-small alert-danger mbottom0 mtop5 mleft40" style="display: none;">
                                            Debe ingresar el CUIT.
                                        </div>
                                        <div id="ValFormato_CuitPJ" class="alert alert-small alert-danger mbottom0 mtop5 mleft40" style="display: none;">
                                            formato inv&aacute;lido. Ej: 30012345673
                                        </div>
                                        <div id="ValDV_CuitPJ" class="alert alert-small alert-danger mbottom0 mtop5 mleft40" style="display: none;">
                                            El CUIT ingresado es inv&aacute;lido.
                                        </div>
                                    </div>
                             
                                    <asp:label runat="server" class="control-label col-sm-1" style="width: 140px; margin-left:-30px">Tipo Ing. Brutos:</asp:label>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div id="Req_TipoIngresosBrutosPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe seleccionar el tipo de Ingresos Brutos.
                                        </div>
                                    </div>
                                      <asp:label runat="server" class="col-sm-1">Nº Ing. Brutos:</asp:label>
                                    <div class="col-sm-2">
                                        <asp:UpdatePanel ID="upd_txtIngresosBrutosPJ" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtIngresosBrutosPJ" runat="server" MaxLength="11" Width="150px" CssClass="form-control" Enabled="false"></asp:TextBox>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                          <asp:label runat="server" class="col-sm-13">Debe ingresar los 11 dígitos sin guiones</asp:label>   
                                        <div id="Req_IngresosBrutosPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Nro de Ing. Brutos.
                                        </div>
                                        <div id="ValFormato_IngresosBrutosPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                             formato inv&aacute;lido. Ej: 20012345673.
                                        </div>
                                    </div>
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_CallePJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar la Calle.
                                        </div>
                                    </div>
                                    <asp:label runat="server" class="control-label col-sm-2">Nro de Puerta (*):</asp:label>
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_NroPuertaPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Nro de Puerta.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-inline">
                                  ...
                                  <asp:label ID="lblPisoPJ" runat="server" class="pleft5 pright5">Piso:</asp:label>
                                    ...
                                    <div class="col-sm-5">
                                        <asp:label ID="lblCPPJ" runat="server" class="control-label col-sm-5 mleft5">C&oacute;digo Postal (*):</asp:label>
                                        ...
                                        <div id="Req_CPPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el c&oacute;digo postal.
                                        </div>
                                        <div id="Val_Formato_CPPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            El formato es inv&aacute;lido, el mismo debe se por ej: 1093 o C1093AAC.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_ProvinciaPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar la Provincia.
                                        </div>
                                    </div>
                                    <asp:label runat="server" class="control-label col-sm-2">Localidad (*):</asp:label>
                                    <div class="col-sm-4">
                                        ...
                                        <div id="Req_LocalidadPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar la Localidad.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-horizontal pright10">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        Debe ser el mail del titular, donde recibirá las notificaciones
                                        <div id="Req_EmailPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el E-mail.
                                        </div>
                                        <div id="ValFormato_EmailPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            formato inv&aacute;lido. Ej: nombre@servidor.com
                                        </div>
                                    </div>
                                    ...
                                    <asp:Panel ID="pnlAgregarTitularSH" runat="server" Style="display: none">
                                        ...
                                        <asp:GridView ID="grdTitularesSH" runat="server" AutoGenerateColumns="false" AllowPaging="false" CssClass="table table-bordered mtop5"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="80px" HeaderText="Acciones" ItemStyle-CssClass="text-center">
                                                    <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Firmante de..." HeaderStyle-CssClass="text-center">
                        <ItemTemplate>
                            <asp:Label ID="lblgrdTitName" runat="server" Width="100%" style="text-align:center;word-wrap: normal; word-break: break-all;" Text='<%# Eval("FirmanteDe") %>' ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                                        ...
                                        <div id="Req_TitularesSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                ...
                                <div class="row pleft20 pright10">
                                    <asp:UpdatePanel ID="updgrdFirmantesPJ" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <div id="Req_FirmantesPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                                Debe ingresar el/los firmante/s.
                                            </div>
                                            <asp:label ID="Label1" runat="server" class="mbottom0 mtop5 pull-right" >
                                                Los campos marcados con "(*)" son obligatorios.
                                            </asp:label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                            ...
                            <div class="form-horizontal pright10 mtop5">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_ApellidosFirPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el/los Apellido/s.
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_NombresFirPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_TipoNroDocFirPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Tipo y Nro. de doc.
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_EmailFirPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el e-mail.
                                        </div>
                                        <div id="Val_Formato_EmailFirPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            formato inv&aacute;lido. Ej: nombre@servidor.com
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div id="Req_TipoCaracterLegalFirPJ" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                            ...
                            <div class="form-horizontal pright10 mtop5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_ApellidosTitSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el/los Apellido/s.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_NombresTitSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el/los Nombre/s.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_TipoNroDocumentoTitSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Tipo y Nro. de doc.
                                        </div>
                                    </div>
                                </div>                                
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_EmailTitSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el e-mail.
                                        </div>
                                        <div id="Val_Formato_EmailTitSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            formato inv&aacute;lido. Ej: nombre@servidor.com
                                        </div>
                                    </div>
                                </div>
                            ...
                            <asp:Panel ID="pnlFirSH" runat="server" CssClass="form-horizontal pright10" style="display: none">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_ApellidosFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el/los Apellido/s.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_NombresFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el/los Nombre/s.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_TipoNroDocumentoFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el Tipo y Nro. de doc.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="Req_EmailFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            Debe ingresar el e-mail.
                                        </div>
                                        <div id="Val_Formato_EmailFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                            formato inv&aacute;lido. Ej: nombre@servidor.com
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div id="Req_TipoCaracterLegalFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                        ...
                                        <asp:Panel ID="pnlCargoFirmanteSH" runat="server" CssClass="form-group" Style="display: none; margin-left: -5px">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <br />
                                                <div id="Req_CargoFirSH" class="alert alert-small alert-danger mbottom0 mtop5" style="display: none;">
                                                    Debe ingresar el cargo que ocupa.
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function ValidarDniCuit() {
            ...
            if (tipoDoc == 1) {
                ...
                var cuit = $("#<%: txtCuitPF.ClientID %>").val().split("-")[1];
        ...
        function validarAgregarPJ() {
            ...
            if (id_tiposociedad == "2") // Sociedad de Hecho
            {
