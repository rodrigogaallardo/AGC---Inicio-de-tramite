...
namespace DataAcess
{
    ...
    public partial class Transf_Firmantes_Solicitud_PersonasFisicas
    {
        ...
        public virtual Transf_Titulares_Solicitud_PersonasFisicas Transf_Titulares_Solicitud_PersonasFisicas { get; set; }
