...
namespace DataAcess
{
    ...
    public partial class Ubicaciones
    {
        ...
        public virtual AreasHospitalarias AreasHospitalarias { get; set; }
        public virtual Comisarias Comisarias { get; set; }
        public virtual DistritosEscolares DistritosEscolares { get; set; }
        public virtual RegionesSanitarias RegionesSanitarias { get; set; }
