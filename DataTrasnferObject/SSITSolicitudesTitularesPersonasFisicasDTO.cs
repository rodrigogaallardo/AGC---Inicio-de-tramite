...
{
	public class SSITSolicitudesTitularesPersonasFisicasDTO
	{
        ...
        public SSITSolicitudesFirmantesPersonasFisicasDTO DtoFirmantes { get; set; }

        //public virtual LocalidadDTO LocalidadDTO { get; set; }
        //public virtual ICollection<SSITSolicitudesFirmantesPersonasFisicasDTO> SSITSolicitudesFirmantesPersonasFisicasDTO { get; set; }
